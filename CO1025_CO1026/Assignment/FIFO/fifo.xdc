...
## Switches
set_property -dict { PACKAGE_PIN M20    IOSTANDARD LVCMOS33 } [get_ports { switch }]; #IO_L7N_T1_AD2N_35 Sch=SW0
set_property -dict { PACKAGE_PIN M19    IOSTANDARD LVCMOS33 } [get_ports { reset }]; #IO_L7P_T1_AD2P_35 Sch=SW1
...
#set_property -dict { PACKAGE_PIN N15    IOSTANDARD LVCMOS33 } [get_ports { rgb_lebs[0] }]; #IO_L21P_T3_DQS_AD14P_35 Sch=LED4_R
...
set_property -dict { PACKAGE_PIN M15    IOSTANDARD LVCMOS33 } [get_ports { rgb_leds[0] }]; #IO_L23N_T3_35 Sch=LED5_R
...
## Buttons
set_property -dict { PACKAGE_PIN D19    IOSTANDARD LVCMOS33 } [get_ports { data_in[0] }]; #IO_L4P_T0_35 Sch=BTN0
set_property -dict { PACKAGE_PIN D20    IOSTANDARD LVCMOS33 } [get_ports { data_in[1] }]; #IO_L4N_T0_35 Sch=BTN1
